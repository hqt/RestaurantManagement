...
public class ItemListFragment extends ListFragment {
	...
	public void onListItemClick(ListView listView, View view, int position, long id) {
		...
		// (the activity, if the fragment is attached to one) that an item has been selected.
		// mCallbacks.onItemSelected(DummyDataModel.ITEMS.get(position).id);
		mCallbacks.onItemSelected(MenuLeftList.CATEGORIES.get(position).id);
