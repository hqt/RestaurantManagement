...
public class ImageAdapterTableBoy extends ArrayAdapter<Table> {
	...
	public ImageAdapterTableBoy(Context context, BusboyViewFragment father, int layoutResourceId, List<Table> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (choice == TABLE_STATUS.DIRTY) {
			holder.imgIcon.setImageResource(R.drawable.actiontable);
			holder.txtTitle.setText("Table " + table.getNo() + ": dirty");
		}
		else {
			holder.imgIcon.setImageResource(R.drawable.freetable);
			holder.txtTitle.setText("Table " + table.getNo() + ": not dirty");
		}
