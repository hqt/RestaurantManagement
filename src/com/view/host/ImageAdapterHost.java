...
public class ImageAdapterHost extends ArrayAdapter<Table> {
	...
	public ImageAdapterHost(Context context, HostViewFragment father, int layoutResourceId, List<Table> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (choice == TABLE_STATUS.FREE) {
			holder.imgIcon.setImageResource(R.drawable.actiontable);
			holder.txtTitle.setText("Table " + table.getNo() + ": free");
		}
		else {
			holder.imgIcon.setImageResource(R.drawable.freetable);
			holder.txtTitle.setText("Table " + table.getNo() + ": non-free");
		}
